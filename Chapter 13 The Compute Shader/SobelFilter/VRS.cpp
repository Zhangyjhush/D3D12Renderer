...
CD3DX12_GPU_DESCRIPTOR_HANDLE VRSPass::OutputSrv()
{
	return mhGpuSrv;
}
...
void VRSPass::OnResize(UINT newWidth, UINT newHeight)
{
...
void VRSPass::Execute(ID3D12GraphicsCommandList* cmdList, ID3D12RootSignature* rootSig, ID3D12PipelineState* pso, CD3DX12_GPU_DESCRIPTOR_HANDLE input)
{
